...
<!-- This task requires implementing a function `filter_datum` that obfuscates certain fields in a log message using regex substitution. The function should be concise (less than 5 lines) and use `re.sub` to perform the substitution in a single regex operation. -->
